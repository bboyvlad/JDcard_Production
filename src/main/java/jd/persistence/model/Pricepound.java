 ...
 */
@Entity
@Table(name = "Pricepound")
public class Pricepound {
    ...
    @Column(name = "PRICEPOUND_ID", unique = true, nullable = false)
    public long getId() {
        return id;
    }
